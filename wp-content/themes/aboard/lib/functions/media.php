...
if ( !function_exists( 'radium_audio' ) ) {
	...
	function radium_audio($postid) {
		...
		$mp3 = get_post_meta($postid, '_radium_audio_mp3', TRUE);
		$ogg = get_post_meta($postid, '_radium_audio_ogg', TRUE);
		$poster = get_post_meta($postid, '_radium_audio_poster', TRUE);
		$height = get_post_meta($postid, '_radium_poster_height', TRUE);
		//$width = get_post_meta($postid, '_radium_poster_width', true);
		...
		?>
				...
				jQuery(document).ready(function(){
					...
					if(jQuery().jPlayer) {
						...
						jQuery('#jquery_jplayer_<?php echo $postid; ?>').jPlayer( { ready : function () { 
							...
							<?php } ?>
							swfPath: "<?php echo RADIUM_JS_URL; ?>/",
			...
			<style>
			/* Fix Jplayer Height if no poster is uploaded */
			<?php if( empty($poster) ) { ?>
		...
		<div class="jp-type-single">
			...
			<div class="jp-gui">
				...
				<div class="jp-no-solution">
			 		<?php _e('<span>Update Required</span>To play the audio you will need to either update your browser to a recent version or update your <a href="http://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.','radium') ?>
				</div>
...
function radium_video($postid) {
	...
	$m4v = get_post_meta($postid, '_radium_video_m4v', true);
	$ogv = get_post_meta($postid, '_radium_video_ogv', true);
	...
	<div class="row">
		<div class="twelve columns">
			...
			<div class="jp-gui">
				...
				<div class="jp-no-solution">
			 		<?php _e('<span>Update Required</span>To play the video you will need to either update your browser to a recent version or update your <a href="http://get.adobe.com/flashplayer/" target="_blank">Flash plugin</a>.','radium') ?>
				</div>
