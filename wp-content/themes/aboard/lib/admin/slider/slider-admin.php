...
/**
 * Works together with the meta Engine to create the slider manager interface 
 */
...
if ( ! class_exists( 'RWMB_Slider_Slides_Field' ) ) 
{
	class RWMB_Slider_Slides_Field
	{
		...
		static function admin_enqueue_scripts() {
			...
			wp_enqueue_style( 'rwmb-slider-slide', RADIUM_ADMIN_URL . '/slider/css/slider-slides.css', array(), RWMB_VER );
			...
			if ( $screen->post_type == 'slider' )
 				wp_enqueue_script( 'rwmb-slider-slide', RADIUM_ADMIN_URL . '/slider/js/slider-slides.js', array( 'jquery', 'farbtastic'), RWMB_VER, true );
...
<!-- HIDE TABS FOR THEME CANVAS										
												<li class="slide-nav-tab"><a href="#slide-nav">' . __('Navigation', 'radium') . '</a></li>
												
												<li class="style-tab"><a href="#slide-style">' . __('Background Styles', 'radium') . '</a></li>
-->												
 											</ul>										
...
<!-- HIDE SLIDER TITLE FOR THEME CANVAS
											...
											</div><!-- END .rwmb-field slide-title --*>								
-->
												...
												<div class="rwmb-field">
													...
													<div class="tester">
														<label class="uploaded-image">' . __('Upload Image / Image URL:', 'radium') . '</label>
														
														<div>
															<input type="text" name="slide-img-src[]" class="rwmb-text uploaded-image" size="50" value="' . $slide_img_src . '">
														</div>	
														<div>
															<input type="button" name="upload-image" class="upload-image" value="' . __('Upload Image', 'radium') . '">
														</div>
													</div>
													...
													</div><!-- END .rwmb-input image-->
															
																			
													<div class="rwmb-image-url">
														
														<div class="rwmb-label">
															<label>' . __('Link (Optional):', 'radium') . '</label>
														</div><!-- END .rwmb-label -->
												...
												<div class="rwmb-field slide-wysiwyg">
													...
													<div class="rwmb-label slide-wysiwyg">
														<label><br/>' . __('Paragraph Content (optional):', 'radium') . '</label>
													</div><!-- END .rwmb-label -->
												...
												<div class="rwmb-field video-embed">
													...
													<div class="rwmb-label">
														<label><br/>' . __('Video Embed Code (optional):', 'radium') . '</label>
													</div><!-- end .rwmb-label -->
													

													<div class="rwmb-input">
													
														<textarea name="slide-video-embed[]" class="rwmb-textarea large-text" cols=1000" rows="5">' . $slide_video_embed . '</textarea>
													</div><!-- end .rwmb-input -->
...
<!-- HIDE NAVIGATION TAB FOR THEME CANVAS
											...
											<div id="slide-nav" class="tabs-content">
												...
												<div class="rwmb-field">	
													...
													<div class="bg-settings">
														...
														<input type="button" name="upload-image" class="upload-image" value="' . __('Upload Nav Icon', 'radium') . '">
													
														</div><!-- END .rwmb-input bg-image --*>
													</div><!-- END .bg-settings --*>
												</div><!-- END .rwmb-field --*>											
...
<!-- HIDE BACKGROUND STYLE TAB FOR THEME CANVAS
												...
												<div class="rwmb-field">
													...
													<div class="bg-settings">
														<div class="rwmb-input bg-image">
															...
															<input type="button" name="upload-image" class="upload-image" value="' . __('Upload BG Image', 'radium') . '">
														</div><!-- END .rwmb-input --*>
													</div><!-- END .bg-settings --*>
														...
														<label class="uploaded-image">' . __('Background Color', 'radium') . '</label>
															<div class="farb-popup-wrapper">
																...
																<div class="farb-popup">
																	...
																	</div><!-- END .farb-popup-inside --*>
																</div><!-- END .farb-popup --*>
															</div><!-- END .farb-popup-wrapper --*>
													</div><!-- END .rwmb-input bgcolorpicker --*>
