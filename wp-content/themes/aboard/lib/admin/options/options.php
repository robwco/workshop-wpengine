...
class RADIUM_Options{
	...
	*/
	function _enqueue(){
		...
		wp_localize_script('radium-opts-js', 'radium_opts', array('reset_confirm' => __('Are you sure? Resetting will loose all custom values.', 'radium'), 'opt_name' => $this->args['opt_name']));
	...
	function _options_page_html(){
		...
		echo '<div class="wrap">';
			...
			echo '<form method="post" action="options.php" enctype="multipart/form-data" id="radium-opts-form-wrapper">';
				...
				echo '<h3 id="radium-opts-theme-heading"><span id="opts-theme-heading">'.RADIUM_THEME_NAME.' WordPress Theme</span>';
				echo '<span id="radium-opts-theme-ver">Version '.RADIUM_THEME_VER.'</span></h3>';
					...
					echo '<div id="radium-opts-save-warn">'.apply_filters('radium-opts-changed-text-'.$this->args['opt_name'], __('', 'radium')).'</div>';
					...
					echo '<ul id="radium-opts-group-menu">';
						...
						if(true === $this->args['show_import_export']){
							echo '<li id="import_export_default_section_group_li" class="radium-opts-group-tab-link-li">';
									echo '<a href="javascript:void(0);" id="import_export_default_section_group_li_a" class="radium-opts-group-tab-link-a" data-rel="import_export_default"> <span>'.__('Import / Export & Reset', 'radium').'</span></a>';
							echo '</li>';
						}
...
//									echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="radium-opts-group-tab-link-a custom-tab" data-rel="dev_mode_default"> <span>'.__('Dev Mode Info', 'radium').'</span></a>';
//							echo '</li>';
//						}
//						
					echo '</ul>';
				...
				echo '<div id="radium-opts-main">';
					...
					if(true === $this->args['show_import_export']){
						echo '<div id="import_export_default_section_group'.'" class="radium-opts-group-tab">';
							...
							echo '<p id="radium-opts-import-action"><input type="submit" id="radium-opts-import" name="'.$this->args['opt_name'].'[import]" class="button-primary" value="'.__('Import', 'radium').'"</p>';
							...
							submit_button(__('Reset All Current Options', 'radium'), 'button-primary', $this->args['opt_name'].'[defaults]', false);
