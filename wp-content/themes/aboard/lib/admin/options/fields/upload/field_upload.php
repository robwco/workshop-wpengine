...
class RADIUM_Options_upload extends RADIUM_Options{	
	...
	*/
	function render(){
		...
		echo ' <a href="javascript:void(0);" class="radium-opts-upload-remove"'.$remove.' rel-id="'.$this->field['id'].'"><img src="'.RADIUM_OPTIONS_URL.'assets/images/icon-delete-small.png" alt="'.__('Remove Upload', 'radium').'"/></a>';
