...
if(!class_exists('RADIUM_Options')){
	require_once( RADIUM_ADMIN_DIR. '/options/options.php' );
}
...
$args['page_title'] = __('ThemeBeans Options Panel', 'radium');
