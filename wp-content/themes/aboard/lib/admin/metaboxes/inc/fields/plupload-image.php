...
if ( ! class_exists( 'RWMB_Plupload_Image_Field' ) )
{
	class RWMB_Plupload_Image_Field extends RWMB_Image_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script(
				'rwmb-plupload-image', 'rwmb_plupload_defaults', array(
					...
					'filters'             => array(
						array(
							'title'      => _x( 'Allowed Image Files', 'image upload', 'radium' ),
		...
		static function html( $html, $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_upload_drop_string', _x( 'Drop images here', 'image upload', 'radium' ) );
			$i18n_or     = _x( 'or', 'image upload', 'radium' );
			$i18n_select = _x( 'Select Files', 'image upload', 'radium' );
			$img_prefix  = $field['id'];
