...
//			$this->pluginURL = plugins_url('', $this->pluginPath);
		...
		function AdminMenus() {
			...
			add_menu_page('WishList Member', 'WishList Member', 'manage_options', 'WishListMember', array(&$this, $firstMenu), $this->pluginURL . '/images/WishList-Icon-Blue-16.png', '99.363317');

			add_submenu_page('WishListMember', $this->Title . ' &laquo; Dashboard', 'Dashboard', 'manage_options', $this->MenuID, array(&$this, $firstMenu));

			foreach ($this->Menus AS $menu_key => $menu_data) {
				add_submenu_page('WishListMember', $this->Title . ' < ' . $menu_data['Name'], $menu_data['Name'], 'manage_options', $this->MenuID . '&wl=' . $menu_key, array(&$this, $firstMenu));
			}
