									...
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_add_app[$levelid]) && in_array($data['Id'],$auto_istags_add_app[$levelid])){
								...
								<?php
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_add_rem[$levelid]) && in_array($data['Id'],$auto_istags_add_rem[$levelid])){
													$selected = "selected='selected'";
												}
								...
								<?php
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_remove_app[$levelid]) && in_array($data['Id'],$auto_istags_remove_app[$levelid])){
													$selected = "selected='selected'";
												}
								...
								<?php
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_remove_rem[$levelid]) && in_array($data['Id'],$auto_istags_remove_rem[$levelid])){
													$selected = "selected='selected'";
												}
								...
								<?php
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_cancelled_app[$levelid]) && in_array($data['Id'],$auto_istags_cancelled_app[$levelid])){
													$selected = "selected='selected'";
												}
								...
								<?php
									foreach($isTagsCategory as $catid=>$name){
										if(isset($isTags[$catid]) && count($isTags[$catid]) > 0){
											...
											foreach($isTags[$catid] as $id=>$data){
												$selected = "";
												if(isset($auto_istags_cancelled_rem[$levelid]) && in_array($data['Id'],$auto_istags_cancelled_rem[$levelid])){
													$selected = "selected='selected'";
												}
