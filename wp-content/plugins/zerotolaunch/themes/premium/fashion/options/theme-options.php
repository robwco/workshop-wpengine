...
Carbon_Container::factory('theme_options', 'Theme Options')
	->add_fields(array(
		...
		Carbon_Field::factory('image', 'website_logo')
			->help_text( 'Optional. The site name will be used if no logo is provided.'),
		Carbon_Field::factory('image', 'header_graphic', 'Header Graphic')
			->help_text('Width: 1080px. Larger images will be automatically scaled & cropped to fit that size.'),
		Carbon_Field::factory('checkbox', 'header_graphic_homepage_only', 'Display header graphic only on the front page.')
