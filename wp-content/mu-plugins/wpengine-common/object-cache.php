...
class WP_Object_Cache {
	...
	function key($key, $group) {
		...
		if ($this->is_generational) {
			...
			return str_replace(' ', '', "$prefix$group:$key:$generation");
		} else {
	...
	function WP_Object_Cache() {
		...
		$this->cache_type = defined('WPE_CACHE_TYPE') ? WPE_CACHE_TYPE : 'standard';
		$this->is_generational = $this->cache_type === 'generational';
	}
}
